...
<Message type="requirement">
  ...
  - You understand [how to package your code](/serverless/functions/how-to/package-function-in-zip/)
</Message>
...
Please refer to our guide on [code packaging](/serverless/functions/how-to/package-function-in-zip/) if you want to use requests.
...
<Message type="note">
  ...
  or by [using a zip-file](/serverless/functions/how-to/package-function-in-zip/).
</Message>
...
Please refer to our guide on [code packaging](/serverless/functions/how-to/package-function-in-zip/), if you want to use `fetch`, `axios`, ...
