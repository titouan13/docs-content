...
6. Check that all settings are correct and click **Create Lifecycle Rule** to confirm.
...
If you wish to delete an object after a set number of days, you can set up am expiration rule that will automate the process. 
