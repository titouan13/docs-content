---
meta:
  title: Migrating data from One Zone - IA to Standard class
  description: This page shows how to migrate your data from one storage class to another.
content:
  h1: Migrating data from one storage class to another
  paragraph: This page shows how to migrate your data from one storage class to another.
dates:
...
2. Copy the objects between the S3 buckets.
  ...
  <Message type="important">
    ...
    If you have objects in C14 Cold Storage (Glacier class) you must restore them before continuing.
