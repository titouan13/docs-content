...
In this tutorial you will learn how to deploy the tool on an [Instance](https://www.scaleway.com/en/virtual-instances/) using the [Docker](https://www.docker.com/) InstantApp. 
...
4. Click **Create a new Instance** to launch its creation. Once the Instance is ready, you are redirected to its information page.
