...
meta:
  ...
  description: Let us address the most common questions you have about Object Storage.
content:
  h1: Object Storage
  paragraph: Let us address the most common questions you have about Object Storage.
...
## Your new backend has been deployed since the 25th of January 2022, does the limit of 500k objects still apply for existing buckets?
...
Yes, it is starting from the 25th of January 2022, the new backend is and available in all regions
