...
This page shows you how to create your first Scaleway Elements Containers namespace. [Namespaces](/compute/containers/concepts/#namespace) allow you to group your containers and share environment variables between them.
...
1. Click **Containers** in the **Serverless** section of the side menu. The list of your Containers displays.
  ...
  <Lightbox src="scaleway-containers-creation.png" alt="" />
