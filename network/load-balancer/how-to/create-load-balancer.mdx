...
7. Choose one of the following options:
  ...
  - Click **Add frontend and backend** to configure a frontend and backend for your Load Balancer immediately, before finishing creation of the Load Balancer. See [how to create frontends and backends](TODO) for help with this step.
