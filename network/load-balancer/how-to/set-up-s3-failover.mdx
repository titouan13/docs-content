...
<Navigation title="See Also">
  <PreviousButton to="/network/load-balancer/how-to/monitor-lb-observability/">How to use a Load Balancer with Private Networks</PreviousButton>
  <NextButton to="/network/load-balancer/how-to/delete-load-balancer/">monitor your Load Balancer with Scaleway Observability</NextButton>
</Navigation>
